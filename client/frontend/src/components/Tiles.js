    ...
    return (
        <div className="cont">
            ...
            }
            {
                props.name != -1 &&
                (
                    <li className="list-group-item" style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                    <Avatar src="../images/img.jpg" />
                    <div className="tile" style={{ display: "flex", "flexDirection": "column", alignItems: "flex-start", justifyContent: "center", marginLeft: "20px" }}>
                        <h6>{props.name}</h6>
